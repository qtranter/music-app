...
class ReplyCommentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun setup(
        ...
        buttonUpVote.setOnClickListener { listener.onReplyUpVoteTapped(parentComment, comment) }
        buttonDownVote.setOnClickListener { listener.onReplyDownVoteTapped(parentComment, comment) }
